...
Route::group(['middleware' => ['auth']], function () {
     ...
     * Body index
     */
    Route::post('bodyindexes/{id}/store',
        ['as' => 'bodyindexes.store', 'uses' => 'BodyIndexesController@store']);
    Route::resource('bodyindexes', 'BodyIndexesController', ['except' => ['store'] ]);

    /**
     * Body index
     */
    Route::post('products/{id}/store',
        ['as' => 'products.store', 'uses' => 'ProductsController@store']);
    Route::resource('products', 'ProductsController', ['except' => ['store'] ]);
